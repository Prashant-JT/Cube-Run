public class Utils {    
  ...
  private void initPositions () {
    //params.add(new int[] {0, -160, 0, 50, 50, 50});  // X, Y, Z, Width, Height, Depth
    //params.add(new int[] {-100, -173, 100, 50, 50, 50}); //-173 es la base para cubo de 50
    params.add(new int[] {-100, -161, 150, 50, 50, 50}); //-161 EJE_Y más tamaño cubito -> límite 
    params.add(new int[] {0, -150, 0, 100, 40, 50});
  }
