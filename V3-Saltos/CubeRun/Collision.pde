public class Collision {
  ...
  public void checkPlatform (){
    ...
    for (Obstacle obs : objects.getList()) {
       ...
       if ((boundsPlayY[0]-5 <= boundsObjY[0] && boundsPlayY[0]-5 >= boundsObjY[1])) {
          if (((boundsPlayX[0]+8 >= boundsObjX[1] && boundsPlayX[0]+8 <= boundsObjX[0]) ||
          ...
          {
            physics.updateDimensions(1, boundsObjY[0]);
            jumping = true; 
          }
       } else if (jumping) {
         jumping = false;
