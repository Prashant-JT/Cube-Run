public class Player {
  ...
  public void updateCamera() {
    float [] pos = getMiddle();  
    camera(pos[0], pos[1] + 80, pos[2] + 200,
            0.0, -150, -100000,
            0.035, -1.0, 0.0);
  ...
  public int [] getBoundsX() {
    float[] pos = getPos();
    return new int[]{int(pos[0])-20, int(pos[1])-20}; 
  }
  
  public int [] getBoundsY() {
    float[] pos = getPos();
    return new int[]{int(pos[2])+20, int(pos[3])+20};
  }
  
  public int [] getBoundsZ() {
    float[] pos = getPos();
    return new int[]{int(pos[4])+20, int(pos[5])+20};
  }
}
