  ...
  public void checkPlatform (){
    ...
    for (Obstacle obs : objects.getList()) {
       ...
       if ((boundsPlayY[0]-7 <= boundsObjY[0] && boundsPlayY[0]-7 >= boundsObjY[1]) && 
          ...
          if (((boundsPlayX[0]+5 >= boundsObjX[1] && boundsPlayX[0]+5 <= boundsObjX[0]) ||
              (boundsPlayX[1]-5 >= boundsObjX[1] && boundsPlayX[1]-5 <= boundsObjX[0])) && 
             ((boundsPlayZ[1]-5 >= boundsObjZ[1] && boundsPlayZ[1]-5 <= boundsObjZ[0]) ||
              (boundsPlayZ[0]+5 >= boundsObjZ[1] && boundsPlayZ[0]+5 <= boundsObjZ[0])))
          {
            physics.updateDimensions(1, boundsPlayY[0]-0.5);
            jumping = true; 
          } 
        } 
        if (!((boundsPlayX[0]+5 >= boundsObjX[1] && boundsPlayX[0]+5 <= boundsObjX[0]) ||
